...
inline flatbuffers::Offset<Blob> CreateBlobDirect(
  ...
  return foonvdla::loadable::CreateBlob(
      _fbb,
...
inline flatbuffers::Offset<MemoryListEntry> CreateMemoryListEntryDirect(
    ...
    uint16_t bind_id = 0,
    uint16_t tensor_desc_id = 0) {
  return foonvdla::loadable::CreateMemoryListEntry(
      _fbb,
      id,
      domain,
      flags,
...
inline flatbuffers::Offset<TaskListEntry> CreateTaskListEntryDirect(
  ...
  return foonvdla::loadable::CreateTaskListEntry(
      _fbb,
      id,
      interface,
      instance,
...
inline flatbuffers::Offset<SubmitListEntry> CreateSubmitListEntryDirect(
  ...
  return foonvdla::loadable::CreateSubmitListEntry(
      _fbb,
      id,
...
inline flatbuffers::Offset<TensorDescListEntry> CreateTensorDescListEntryDirect(
    ...
    uint32_t stride_6 = 0,
    uint32_t stride_7 = 0) {
  return foonvdla::loadable::CreateTensorDescListEntry(
      _fbb,
      name ? _fbb.CreateString(name) : 0,
      id,
      mem_id,
...
inline flatbuffers::Offset<Loadable> CreateLoadableDirect(
  ...
  return foonvdla::loadable::CreateLoadable(
      _fbb,
      version,
...
inline const foonvdla::loadable::Loadable *GetLoadable(const void *buf) {
  return flatbuffers::GetRoot<foonvdla::loadable::Loadable>(buf);
}

inline bool VerifyLoadableBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<foonvdla::loadable::Loadable>(nullptr);
}

inline void FinishLoadableBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<foonvdla::loadable::Loadable> root) {
  fbb.Finish(root);
}
